...
def neural_regression(feature_map, neural_response, regression=Ridge(alpha=1.0), 
                      cv_splits=5, score_type='pearson_r', use_tqdm=False, **kwargs):
    ...
    if cv_splits is None:
        warn('No cv_splits selected. Returning fitted regression object...')
